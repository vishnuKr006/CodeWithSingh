...
var typed = new Typed('#element', {
    strings: ['StudySync', 'Learn to code with StudySync', 'Our innovative platform offers an',
    'effortless and seamless approach to learning,',
    'empowering students of all ages', 'to achieve brighter futures.',
    'Browse courses and find out the', 'best course for you. Its free!',
    'StudySync is my attempt to teach', 'basics and those coding',
    'techniques to people in short', 'time which took me ages to learn.',
    '&amp; here I will teach you', 'Basic to Advanced Programming Languages like :',
    'Html, Css, Javascript, Php, Scala', 'Ruby, C++, Java, Phython, &amp; C Language',
    '&amp; Some Frameworks Like ;', 'React, Angular &amp; Vue.Js', 'Feel Free ! to ask', 'anything With StudySync'],
    typeSpeed: 70,
    BackSpeed: 10,
    loop: true
});
